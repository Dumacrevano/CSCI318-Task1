...
for i in data:
    if (x >= 1):
        arr_lines = i.split(',')
        entry = {'Name': "Testpool/"+arr_lines[0], 'RGB': "("  + arr_lines[1] + ", " + arr_lines[2] +  ", " + arr_lines[3] + ")",  'Type': arr_lines[4], 'Dimension': arr_lines[5],'BitDepth': arr_lines[6], 'Size':arr_lines[7], 'Signature':arr_lines[8]}
